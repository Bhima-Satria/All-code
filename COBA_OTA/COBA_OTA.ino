...
if (Up   == LOW) { delay (100); goto menu3; }
if (Down == LOW) { delay (100); goto menu;}
if (Ok   == LOW) { delay (100); goto menu2;}
}
...
if (Ok    == LOW) { delay (100); goto menu1; }
if (Up    == LOW) {lcd.setCursor(10,0); lcd.print(Sp++);}
if (Down  == LOW) {lcd.setCursor(10,0); lcd.print(Sp--);}
}
...
//if (Up   == LOW) { delay (100); goto menu1; }
if (Down == LOW) { delay (100); goto menu1;}
if (Ok   == LOW) { delay (100); goto menu4;}
}
...
if (Ok    == LOW) { delay (100); goto menu5; }
if (Up    == LOW) {lcd.setCursor(10,0); lcd.print(SpH++);}
if (Down  == LOW) {lcd.setCursor(10,0); lcd.print(SpH--);}
...
if (Ok    == LOW) { delay (100); goto menu6; }
if (Up    == LOW) {lcd.setCursor(10,0); lcd.print(SpH1++);}
if (Down  == LOW) {lcd.setCursor(10,0); lcd.print(SpH1--);}
...
if (Ok    == LOW) { delay (100); goto menu3; }
if (Up    == LOW) {lcd.setCursor(10,0); lcd.print(SpH2++);}
if (Down  == LOW) {lcd.setCursor(10,0); lcd.print(SpH2--);}
...
if (Down== LOW) { delay(100); goto menu; }
if (String(SpH) == jam_a && String (SpH1) == jam_b && String(SpH2) == tanggal ) { delay (100); goto menu;}
}
} 
...
if(WiFi.status()== WL_CONNECTED){   //Check WiFi connection status
  ...
  if (jam_a == "00") {jam_a = "0";} 
  else if (jam_a == "01") {jam_a = "1";} 
  else if (jam_a == "02") {jam_a = "2";} 
  else if (jam_a == "03") {jam_a = "3";} 
  else if (jam_a == "04") {jam_a = "4";} 
  else if (jam_a == "05") {jam_a = "5";} 
  else if (jam_a == "06") {jam_a = "6";} 
  else if (jam_a == "07") {jam_a = "7";} 
  else if (jam_a == "08") {jam_a = "8";} 
  else if (jam_a == "09") {jam_a = "9";} 
  else jam_a = jam_a;
  
  jam_b = payload1.substring(205, 207);

  if (jam_b == "00") {jam_b = "0";} 
  else if (jam_b == "01") {jam_b = "1";} 
  else if (jam_b == "02") {jam_b = "2";} 
  else if (jam_b == "03") {jam_b = "3";} 
  else if (jam_b == "04") {jam_b = "4";} 
  else if (jam_b == "05") {jam_b = "5";} 
  else if (jam_b == "06") {jam_b = "6";} 
  else if (jam_b == "07") {jam_b = "7";} 
  else if (jam_b == "08") {jam_b = "8";} 
  else if (jam_b == "09") {jam_b = "9";} 
  else jam_b = jam_b;

  jam_c = payload1.substring(191,199);
  tanggal = payload1.substring(199,201);
  if (tanggal == "00") {tanggal = "0";} 
  else if (tanggal == "01") {tanggal = "1";} 
  else if (tanggal == "02") {tanggal = "2";} 
  else if (tanggal == "03") {tanggal = "3";} 
  else if (tanggal == "04") {tanggal = "4";} 
  else if (tanggal == "05") {tanggal = "5";} 
  else if (tanggal == "06") {tanggal = "6";} 
  else if (tanggal == "07") {tanggal = "7";} 
  else if (tanggal == "08") {tanggal = "8";} 
  else if (tanggal == "09") {tanggal = "9";} 
